        ...
        <div style="margin-right:130px;">
            ...
            <div style="text-align:right;margin-top:10px;margin-bottom:10px;">
                ...
                <a href="${pageContext.request.contextPath}/OrderServlet?method=saveOrder">
                    <%--提交表单 --%>
                <input type="button" width="100" value="提交订单" name="submit" border="0" style="background: url('${pageContext.request.contextPath}/img/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);height:35px;width:100px;color:white;">
                </a>
            </div>
        </div>
    </c:if>
...
<script>
    $(function () {
        $('.delete').click(function () {
            if (confirm("确认删除？")) {
                var pid = this.id;
                location.href = "${pageContext.request.contextPath}/CartServlet?method=removeCartItem&id=" + pid;
            }
        })
