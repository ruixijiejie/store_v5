...
public class OrderDaoImp implements OrderDao {
    @Override
    public void saveOrder(Connection coon, Order order) throws Exception {
        ...
        qr.update(coon, sql, params);
    }

    @Override
    public void saveOrderItem(Connection coon, OrderItem item) throws Exception {
